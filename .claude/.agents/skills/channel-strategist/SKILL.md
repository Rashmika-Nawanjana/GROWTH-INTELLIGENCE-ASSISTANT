...
- Output recommendations with:
  ...
  - Expected performance indicators based on signals
  - A/B test suggestions per channel
...
**Best Practices**:
- Tie every recommendation back to live market/audience signals.
- Support ephemeral UI: prepare data for clickable channel selector.
- Favor hybrid approaches when signals support testing both channels in parallel.