...
- Create professional, concise documents focused on Lilian as the insight-first full-cycle AI SDR.
- Include sections: Objective, Target Audience & Pain Points, Key Messaging Angles (with hypotheses), Variants Summary, Channel Strategy, Success Metrics, Next Steps.

**Output Format**:
- Clean markdown or JSON-ready structure for rendering as a card/one-pager UI.
- Highlight traceable signals and hypotheses.
- Make it downloadable-friendly (ready for copy or export).
