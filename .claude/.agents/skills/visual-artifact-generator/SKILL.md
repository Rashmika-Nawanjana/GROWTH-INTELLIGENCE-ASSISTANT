...
- Ground visuals in live signals and variants (e.g., ROI angle highlights, competitive gaps).
- For Lilian-focused assets: emphasize insight-first research, 24/7 autonomy, learning loop.

**Output Format**:
- Ready-to-use image generation prompt (detailed, style-specific)
- Or inline HTML/Tailwind snippet for simple artifacts (tables, cards) that can be rendered in the UI
- Description of what the visual communicates and which signals it draws from
